...
export default function InvestmentPropertyGuide() {
  ...
  const sections: Section[] = [
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <h4 className="font-semibold text-red-600">Higher Purchase Tax:</h4>
          <p>
          ...
          <div className="bg-red-500/10 p-4 rounded-lg border border-red-500/20 my-4">
            <p className="text-sm">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <div className="bg-amber-500/10 p-4 rounded-lg border border-amber-500/20 my-4">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <h4 className="font-semibold text-red-600">Key Risks:</h4>
          <ul className="list-disc pl-5 space-y-2">
            <li>
