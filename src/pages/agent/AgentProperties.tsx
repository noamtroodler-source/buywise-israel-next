...
import {
  ...
  ArrowUpDown, ArrowUp, ArrowDown, Archive, Key,
} from 'lucide-react';
...
import { useArchiveAgencyListing, useUnpublishAgencyListing } from '@/hooks/useAgencyListings';
...
function getSortValue(listing: any, key: SortKey) {
  ...
  if (key === 'inquiries') return Number(listing.inquiries_count || listing.my_inquiries_count || 0);
