import cohenLevyPartners from '@/assets/professionals/cohen-levy-partners.png';
...
import katzCoAccounting from '@/assets/professionals/katz-co-accounting.png';
import sternTaxAdvisory from '@/assets/professionals/stern-tax-advisory.png';
import leviFinancialPartners from '@/assets/professionals/levi-financial-partners.png';
import dvoraMizrachiCpa from '@/assets/professionals/dvora-mizrachi-cpa.png';

export const PROFESSIONAL_LOGOS: Record<string, string> = {
  'cohen-levy-partners': cohenLevyPartners,
  ...
  'katz-co-accounting': katzCoAccounting,
  'stern-tax-advisory': sternTaxAdvisory,
  'levi-financial-partners': leviFinancialPartners,
  'dvora-mizrachi-cpa': dvoraMizrachiCpa,
};
