...
interface PropertySubmittedDialogProps {
  open: boolean;
  onClose: () => void;
...
export function PropertySubmittedDialog({ 
  open, 
  onClose, 
  propertyTitle, 
  isResubmission = false 
}: PropertySubmittedDialogProps) {
      ...
      <DialogContent className="sm:max-w-md rounded-2xl">
        <DialogHeader className="text-center space-y-4">
          ...
          <DialogTitle className="text-2xl font-bold">
            {isResubmission ? 'Listing Resubmitted!' : 'Listing Submitted!'}
          </DialogTitle>
          
          <DialogDescription className="text-base text-muted-foreground">
            <span className="font-medium text-foreground">"{propertyTitle}"</span> has been submitted for review.
          </DialogDescription>
        </DialogHeader>
