...
import { Star, X, Clock, Percent, Zap, BookOpen } from 'lucide-react';
    ...
    <div className="relative rounded-2xl overflow-hidden border border-amber-200/60 bg-gradient-to-r from-amber-50 to-yellow-50 dark:from-amber-950/30 dark:to-yellow-950/30 dark:border-amber-800/40 p-5">
      ...
      <div className="flex flex-wrap gap-2 mb-4">
        <span className="inline-flex items-center gap-1 text-xs font-medium px-2.5 py-1 rounded-full bg-amber-100 text-amber-800 dark:bg-amber-900/40 dark:text-amber-300 border border-amber-200 dark:border-amber-700">
          <Clock className="h-3 w-3" /> 60-day trial
        </span>
        <span className="inline-flex items-center gap-1 text-xs font-medium px-2.5 py-1 rounded-full bg-amber-100 text-amber-800 dark:bg-amber-900/40 dark:text-amber-300 border border-amber-200 dark:border-amber-700">
          <Percent className="h-3 w-3" /> 25% off for 10 months
        </span>
        <span className="inline-flex items-center gap-1 text-xs font-medium px-2.5 py-1 rounded-full bg-amber-100 text-amber-800 dark:bg-amber-900/40 dark:text-amber-300 border border-amber-200 dark:border-amber-700">
          <Zap className="h-3 w-3" /> Up to 800 free credits
        </span>
      </div>

      {/* Credit schedule summary */}
      <div className="grid sm:grid-cols-2 gap-3">
        <div className="rounded-xl bg-amber-100/60 dark:bg-amber-900/20 border border-amber-200/60 dark:border-amber-700/40 p-3">
          <p className="text-xs font-semibold text-amber-900 dark:text-amber-200 mb-0.5">
            <Zap className="h-3 w-3 inline mr-1" />
            Your Credit Schedule
          </p>
          <p className="text-xs text-amber-700 dark:text-amber-400">
            <strong>150 credits/mo</strong> for months 1–2 (during trial)
          </p>
          <p className="text-xs text-amber-700 dark:text-amber-400">
            <strong>50 credits/mo</strong> for 10 months after trial
          </p>
          <p className="text-xs text-amber-600 dark:text-amber-500 mt-1">
            800 credits total · ~₪16,000 in free visibility value
          </p>
        </div>
        ...
        <div className="rounded-xl bg-amber-100/60 dark:bg-amber-900/20 border border-amber-200/60 dark:border-amber-700/40 p-3">
          ...
          <p className="text-xs text-amber-700 dark:text-amber-400">
            As a Founding Member you'll be invited to share your growth story with our buyer and investor audience — featured on our blog and social channels.
          </p>
        </div>
      </div>
    </div>
