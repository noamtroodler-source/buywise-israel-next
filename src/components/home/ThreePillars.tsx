...
const pillars = [
  {
    ...
    description: 'Agencies vetted for international buyers — no Hebrew, no middlemen, just direct access.',
  ...
  },
  {
    ...
    description: 'Compare scenarios, pressure-test trade-offs, and move forward — or wait — with confidence.',
