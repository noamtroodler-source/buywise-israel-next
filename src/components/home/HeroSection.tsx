    ...
    <section className="relative min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="container relative z-10 py-20">
        ...
        >
          ...
          >
            <span className="text-accent text-2xl align-middle">•</span> English-first discovery <span className="text-accent text-2xl align-middle">•</span> Market context in every listing <span className="text-accent text-2xl align-middle">•</span> True cost transparency
          </p>
